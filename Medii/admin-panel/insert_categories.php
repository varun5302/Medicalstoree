...
<body>
    <div align="center"><h1>Insert Categories</h1><br><br><br><br><br></div>
    <div id="md">
        <div id="d2">
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="file" id="catimg" name="catimg"><br><br>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $insq = "INSERT INTO `categories`(`catName`, `catImg`) VALUES ('$catname','$file_name')";
